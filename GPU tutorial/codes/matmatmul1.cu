/* L-31 MCS 572 Wed 2 Nov 2016 : matmatmul1.cu 
 ...
 * In this version, a matrix is stores as one dimensional array
 * and we use only the x component of the threadIdx. */
...
int main ( int argc, char*argv[] )
{
   ...
   else
   {
      ...
      matrixMultiply<<<n*p,1>>>(n,m,p,Adevice,Bdevice,Cdevice);
